...
enum class Counter : size_t {
  ...
  SolverVisiblePurchaseRefills,
  SolverVisiblePurchaseGenerated,
  SolverVisiblePurchaseVisited,
  SolverVisiblePurchaseVisited0,
  SolverVisiblePurchaseVisited1,
  SolverVisiblePurchaseVisited2To4,
  SolverVisiblePurchaseVisited5Plus,
  SolverVisiblePurchaseApplyCalls,
