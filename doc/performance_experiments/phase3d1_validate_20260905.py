#!/usr/bin/env python3
"""Deployment, oracle and sanitizer gates for the isolated 3D-1 branch."""
import argparse
import hashlib
import shutil
import sys

from phase3d1_record_20260905 import ROOT, RELEASE, run, save
...
def asan():
    ...
    checked('configure_asan', ['cmake', '-S', str(ROOT), '-B', str(build),
        ...
        '-DCSPLENDOR_VERIFY_SOLVER_ROLLBACK=ON', '-DCSPLENDOR_VERIFY_REVEAL_SCORE_ORDER=ON', '-DCSPLENDOR_VERIFY_REVEAL_SEARCH_STATE=ON',
