#!/usr/bin/env python3
"""Phase3D-P2 orchestration; timing/bootstrap/digests use the existing harness."""
import argparse
import gzip
import json
import shlex
...
RAW = ROOT / 'doc/performance_experiments/raw/phase3dp2'
BASE_SOURCE = Path('/home/kuboyu/workspace/repos/csplendor-score-once')
BASE = BASE_SOURCE / 'build/3dp1-release'
RELEASE = ROOT / 'build/3dp2-release'
