#!/usr/bin/env python3
"""Deployment, oracle and sanitizer gates for the isolated 3D-P1 branch."""
import argparse
import hashlib
import shutil
import sys

from phase3dp1_record_20260905 import ROOT, RELEASE, run, save
...
def verify():
    ...
    for label in ('diagnostic', 'reference-diagnostic'):
        directory = ROOT / ('build/3dp1-' + label)
