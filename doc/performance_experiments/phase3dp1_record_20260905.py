#!/usr/bin/env python3
"""Phase3D-P1 orchestration; timing/bootstrap/digests use the existing harness."""
import argparse
import gzip
import json
import shlex
...
RAW = ROOT / 'doc/performance_experiments/raw/phase3dp1'
BASE_SOURCE = Path('/tmp/csplendor-codex56-phase0')
BASE = Path('/tmp/csplendor-phase3c-stage1-on')
RELEASE = ROOT / 'build/3dp1-release'
